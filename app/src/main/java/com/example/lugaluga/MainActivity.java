...
public class MainActivity extends AppCompatActivity {
     ...
     private String[] cidades = {
             "São Carlos","Araraquara","Ibaté","Ribeirão Preto","Dourado","Descalvado","Porto Ferreira",
         "Santa Rita do Passa Quatro", "Tambaú","Pirassununga","Ribeirão Bonito", "Jaboticabal",
         "Franca","São Paulo","Itapetininga","Brotas","Jaú","Bauru","Rio Claro"};
